...
ArcGIS Field Maps e integrada con ArcGIS Enterprise 10.8.1 + ArcFM sobre Oracle.
...
- **Backend** Python (FastAPI) sobre Oracle, con capa de agentes de validación y RAG normativo.
...
| [`docs/ADDENDUM-01-ArcGIS-FieldMaps-Oracle.md`](docs/ADDENDUM-01-ArcGIS-FieldMaps-Oracle.md) | Análisis de Field Maps, arquitectura ArcGIS 10.8.1 + Oracle, abstracción del modelo de datos. **Corrige el SRS donde discrepen** |
